...
public:
	...
	void ReturnTrueIfAllBigNumsArePerfectPowers();
	void ReturnFalseIfAllBigNumsAreNotPerfectPowers();
private:
	PerfectPower pp;
	...
	NTL::Vec<NTL::ZZ> bignumPerfectPowers;
	NTL::Vec<NTL::ZZ> bignumNotPerfectPowers;
	...
	CPPUNIT_TEST(PerfectPowerTests::ReturnTrueIfAllBigNumsArePerfectPowers);
	CPPUNIT_TEST(ReturnFalseIfAllBigNumsAreNotPerfectPowers);
